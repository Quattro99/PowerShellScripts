...
.NOTES
   ===========================================================================
	...
	Filename:    Mitel_OfficeSuite-4.1.0.ps1
   ===========================================================================
.COMPONENT
...
Try {
    ...
    if ($Remove) {
        ...
        $Application = "$PSScriptRoot\Package\setup[10.0.70.10][9080][2809].exe"  # Specify the executable for uninstallation
        $Argument = '/S /x /v/qn'  # Specify the arguments for uninstallation
    ...
    # If Remove is not specified, perform installation
        ...
        $Application = "$PSScriptRoot\Package\setup[10.0.70.10][9080][2809].exe"  # Specify the executable for installation
        $Argument = '/S /v/qn'  # Specify the arguments for installation
