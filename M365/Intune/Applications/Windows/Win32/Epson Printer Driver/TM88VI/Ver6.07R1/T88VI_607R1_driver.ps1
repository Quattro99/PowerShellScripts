...
.DESCRIPTION
   ...
   It uses the appropriate executable methods for installation and uninstallation, 
...
.NOTES
   ===========================================================================
	...
	Filename:    T88VI_607R1_driver.ps1
   ===========================================================================
.COMPONENT
...
.FUNCTIONALITY
   - Handles application installation and uninstallation.
...
Try {
    ...
    if ($Remove) {
        ...
        $Application = "T88VI_607R1_Uninstaller.exe"  # Specify the executable for uninstallation
        $Argument = '/s /uninstall'  # Specify the arguments for uninstallation
    ...
    # If Remove is not specified, perform installation
        ...
        $Application = "T88VI_607R1_Installer.exe"  # Specify the executable for installation

        # Start the installation process
        $Result = Start-Process $Application -Wait -PassThru
        $ExitCode = $Result.ExitCode
