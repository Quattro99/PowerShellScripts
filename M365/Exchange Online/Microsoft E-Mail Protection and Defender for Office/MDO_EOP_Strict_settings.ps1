...
function malewarefilterpolicy {
  ...
  New-MalwareFilterPolicy -Name "duo Strict - Anti-Malware Policy" -EnableFileFilter $True -FileTypes $filetypes -FileTypeAction Reject -ZapEnabled $True -QuarantineTag AdminOnlyAccessPolicy -EnableInternalSenderAdminNotifications $False -EnableExternalSenderAdminNotifications $False -CustomNotifications $False
  New-MalwareFilterRule -Name "duo Strict - Anti-Malware Policy" -MalwareFilterPolicy "duo Strict - Anti-Malware Policy" -RecipientDomainIs $domains
}
...
function safeattachmentpolicy {
  ...
  New-SafeAttachmentPolicy -Name "duo Strict - Safe Attachment Policy" -Enable $True -Action Block -QuarantineTag AdminOnlyAccessPolicy -Redirect $False
  New-SafeAttachmentRule -Name "duo Strict - Safe Attachment Rule" -SafeAttachmentPolicy "duo Strict - Safe Attachment Policy" -RecipientDomainIs $domains
...
function safelinkspolicy {
  ...
  New-SafeLinksPolicy -Name "duo Strict - Safe Links Policy" -EnableSafeLinksForEmail $True -EnableForInternalSenders $True -ScanUrls $True -DeliverMessageAfterScan $True -DisableUrlRewrite $False -EnableSafeLinksForTeams $True -EnableSafeLinksForOffice $True -TrackClicks $True -AllowClickThrough $False -EnableOrganizationBranding $True
  New-SafeLinksRule -Name "duo Strict - Safe Links Rule" -SafeLinksPolicy "duo Strict - Safe Links Policy" -RecipientDomainIs $domains
}
