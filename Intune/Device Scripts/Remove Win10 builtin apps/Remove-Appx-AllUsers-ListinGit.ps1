...
.DESCRIPTION
    ...
    The Remove-List-Appx list (txt file) is hosted in Azure Blob storage or GitHub so it can be dynamically updated.
...
.NOTES
    ...
    ===========================================================================
    Created on:       27th June 2022
    Created by:       Michele Blum
    Filename:         Remove-Appx-AllUsers-CloudSourceList.ps1
    ===========================================================================

.COMPONENT
    Intune, Operating System

.ROLE
    Intune administrator

.FUNCTIONALITY
    Remove specified built-in apps from Windows 11 for all users.
#>
