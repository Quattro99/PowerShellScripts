...
.NOTES
   ===========================================================================
	...
	Filename:    Default_Win32_App.ps1
   ===========================================================================
.COMPONENT
...
Try {
    ...
    if ($Remove) {
        ...
        $Application = "ENTER EXE HERE"  # Specify the executable for uninstallation
        $Argument = 'ENTER ARGUMENTS HERE'  # Specify the arguments for uninstallation
    ...
    # If Remove is not specified, perform installation
        ...
        $Application = "ENTER EXE HERE"  # Specify the executable for installation
        $Argument = 'ENTER ARGUMENTS HERE'  # Specify the arguments for installation
